...
async function bootstrap_style() {
...
function watch(){
  ...
  gulp.watch('src/bootstrap/**/*.scss',bootstrap_style);
  gulp.watch('src/images/**/*.*',compress_img);
...
exports.default = gulp.series(
  gulp.parallel([styles,bootstrap_style]),
